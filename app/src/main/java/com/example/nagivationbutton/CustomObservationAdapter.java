...
public class CustomObservationAdapter extends RecyclerView.Adapter<MyViewHolderObservations>{

    private Context context;
    private List<Observation> dataListObservation;
    DatabaseHelper dbHelper;
    DetailActivity detailActivity;


    public CustomObservationAdapter(Context context, List<Observation> dataListObservation, DatabaseHelper dbHelper, DetailActivity detailActivity) {
    ...
    public void resetDataList(List<Observation> newDataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolderObservations holder, int position) {
        Observation observationData = dataListObservation.get(position);
...
class MyViewHolderObservations extends RecyclerView.ViewHolder{
    ...
    List<Observation> dataList;
    DatabaseHelper dbHelper;
    CustomObservationAdapter adapterObservation;


    public MyViewHolderObservations(@NonNull View itemView, List<Observation> dataList, DatabaseHelper dbHelper, CustomObservationAdapter adapterObservation) {
        super(itemView);
        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    Observation observationData = dataList.get(position);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    Intent intent = new Intent(itemView.getContext(), UpdateObservation.class);
