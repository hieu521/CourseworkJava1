...
public class CustomHikingAdapter extends RecyclerView.Adapter<HikingViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HikingViewHolder holder, int position) {
        ...
        holder.textViewLengthOfHike.setText("Length Of Hike: "+ dataList.get(position).getLength());
        holder.textViewDifficultLevel.setText("Difficult Level: "+ dataList.get(position).getDifficulty());
...
class HikingViewHolder extends RecyclerView.ViewHolder{
    ...
    public HikingViewHolder(@NonNull View itemView, List<Hiking> dataList, DatabaseHelper dbHelper, CustomHikingAdapter adapter) {
        super(itemView);
        this.dataList = dataList;
        this.dbHelper = dbHelper;
