...
public class DetailActivity extends AppCompatActivity {
    ...
    List<Observation> dataListObservation;
    CustomObservationAdapter adapterObservation;
    DatabaseHelper dbHelper;
    int hikingId;
    Hiking hikingData; // Thêm biến để lưu trữ tên hiking
...
//        dbHelper.insertObservationRecord("Sample Name 3", "2023-10-12 12:00 PM", "This is a sample comment 3.", 61);
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                Observation observationData = new Observation(id, name, date, comment, hikingId);
        ...
        adapterObservation = new CustomObservationAdapter(DetailActivity.this, dataListObservation, dbHelper, this);
        recyclerViewDetails.setAdapter(adapterObservation);

        fabCreate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DetailActivity.this, AddingObservation.class);
    ...
    public void refreshData() {
        ...
        List<Observation> newDataList = new ArrayList<>();
        int id = 0;
        Cursor cursor = dbHelper.getAllObservationRecords(hikingId);
